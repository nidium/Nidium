...
Canvas.implement({
	setPath : function(data, units, advx, advy, scale){
		this.save();
		...
		this.translate((units-advx)/2, -advy);

		for (var n=0; n<data.length; n++){
			var c = data[n].command,
				p = data[n].points;
			...
			switch (c) {
				...
				case 'A':
					...
					this.arc(0, 0, r, theta, theta + dTheta, 1 - fs);
					this.scale(1 / scaleX, 1 / scaleY);
					this.rotate(-psi);
					this.translate(-cx, -cy);
					break;
