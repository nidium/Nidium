...
static JSFunctionSpec storage_funcs[] = {
    JS_FN("set", native_storage_set, 2, JSFUNCTIONPROPS),
    JS_FN("get", native_storage_get, 1, JSFUNCTIONPROPS),
    JS_FS_END
};

static JSFunctionSpec window_funcs[] = {
    JS_FN("openFileDialog", native_window_openFileDialog, 2, JSFUNCTIONPROPS),
    JS_FN("openDirDialog", native_window_openDirDialog, 1, JSFUNCTIONPROPS),
    JS_FN("setSize", native_window_setSize, 2, JSFUNCTIONPROPS),
    JS_FN("requestAnimationFrame", native_window_requestAnimationFrame, 1, JSFUNCTIONPROPS),
    JS_FN("center", native_window_center, 0, JSFUNCTIONPROPS),
    JS_FN("setPosition", native_window_setPosition, 2, JSFUNCTIONPROPS),
    JS_FN("setFrame", native_window_setFrame, 4, JSFUNCTIONPROPS),
    JS_FN("notify", native_window_notify, 2, JSFUNCTIONPROPS),
    JS_FN("quit", native_window_quit, 0, JSFUNCTIONPROPS),
    JS_FN("close", native_window_close, 0, JSFUNCTIONPROPS),
    JS_FN("open", native_window_open, 0, JSFUNCTIONPROPS),
    JS_FN("setSystemTray", native_window_setSystemTray, 1, JSFUNCTIONPROPS),
    JS_FN("openURL", native_window_openURLInBrowser, 1, JSFUNCTIONPROPS),
    JS_FN("exec", native_window_exec, 1, JSFUNCTIONPROPS),
    JS_FS_END
};
