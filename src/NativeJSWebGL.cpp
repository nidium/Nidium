...
bool NGL_uniformxfv(NativeCanvas3DContext *glctx, JSContext *cx, unsigned int argc, JS::Value *vp, int nb)
{
    ...
    if (!JS_ConvertArguments(cx, args, "oo", &location, &array)) {
        return false;
    }
...
bool NGL_uniformMatrixxfv(NativeCanvas3DContext *glctx, JSContext *cx, unsigned int argc, JS::Value *vp, int nb)
{
    ...
    if (!JS_ConvertArguments(cx, args, "obo", &location, &transpose, &array)) {
        return false;
    }
...
bool NGL_vertexAttribxfv(NativeCanvas3DContext *glctx, JSContext *cx, unsigned int argc, JS::Value *vp, int nb)
{
    ...
    GLuint index;
    GLfloat *carray;
    JS::Value *argv;  //@TODO: JS::ValueRoot
    JS::RootedObject tmp(cx);
    JS::RootedObject array(cx);
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "oo", &program, &shader)) {
        return false;
    }
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "ouS", &program, &vertex, &name)) {
        return false;
    }
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "uo", &target, &buffer)) {
        return false;
    }
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "uo", &target,
        &texture)) {
        return false;
    }
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "uuuu",
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "uou",
        &target, &array, &usage)) {
        return false;
    }
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "uuo",
        &target, &offset, &array)) {
        return false;
    }
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "o", &shader)) {
        return false;
    }
...
//{
    ...
    JS_GetProperty(cx, JS_GetGlobalObject(cx /*, &args.callee()*/), "WebGLBuffer", &proto);
    ret = JS_NewObject(cx, &WebGLBuffer_class, proto.toObject(), JS::NullPtr());
...
//{
    ...
    JS_GetProperty(cx, JS_GetGlobalObject(cx /*, &args.callee()*/), "WebGLFramebuffer", &proto);
    ret = JS_NewObject(cx, &WebGLFramebuffer_class, &proto.toObject(), JS::NullPtr());
...
//{
    ...
    JS_GetProperty(cx, JS_GetGlobalObject(cx /*, &args.callee()*/), "WebGLRenderbuffer", &proto);
    ret = JS_NewObject(cx, &WebGLRenderbuffer_class, &proto.toObject(), JS::NullPtr());
...
//{
    ...
    JS_GetProperty(cx, JS_GetGlobalObject(cx /*, &args.callee()*/), "WebGLProgram", &proto);
    ret = JS_NewObject(cx, &WebGLProgram_class, proto.toObject(), JS::NullPtr());
...
//{
    ...
    JS_GetProperty(cx, JS_GetGlobalObject(cx /*, &args.callee()*/), "WebGLShader", &proto);
    ret = JS_NewObject(cx, &WebGLShader_class, &proto.toObject()), JS::NullPtr());
...
//{
    ...
    JS_GetProperty(cx, JS_GetGlobalObject(cx /*, &args.callee()*/), "WebGLTexture", &proto);

    ret = JS_NewObject(cx, &WebGLTexture_class, &proto.toObject(), JS::NullPtr());
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "oS", &program, &name)) {
        return false;
    }
    ...
    if (location < 0 ) {
        ...
        JS_GetProperty(cx, JS_GetGlobalObject(cx /*, &args.callee()*/), "WebGLUniformLocation", &proto);
        ret = JS_NewObject(cx, &WebGLUniformLocation_class, &proto.toObject(), JS::NullPtr());
...
#define SET_PROP(prop, val) JS_SetProperty(cx, obj, prop, val)
    ...
    JS_GetProperty(cx, JS_GetGlobalObject(cx /*, &args.callee()*/), "WebGLShaderPrecisionFormat", &proto);
    JS::RootedObject obj(cx, JS_NewObject(cx, &WebGLShaderPrecisionFormat_class, &proto.toObject(), JS::NullPtr()));
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "ou", &program, &index)) {
        return false;
    }
    ...
    JS_GetProperty(cx, JS_GetGlobalObject(cx /*, &args.callee()*/), "WebGLActiveInfo", &proto);
    JS::RootedObject obj(cx, JS_NewObject(cx, &WebGLActiveInfo_class, &proto.toObject(), JS::NullPtr()));
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "oS", &program, &attr)) {
        return false;
    }
...
//{
    ...
    switch (name) {
        ...
        case NGL_COLOR_WRITEMASK: // 4 bools
        {
            ...
            JS::RootedObject obj(cx, JS_NewArrayObject(cx, 4, vals));
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "ou",
        &program, &param)) {
        return false;
    }
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "o", &program)) {
        return false;
    }
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "ou", &shader, &pname)) {
        return false;
    }
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "uuii",
...
//{
    ...
    if (!JS_ConvertArguments(cx, args, "oS", &shader, &source)) {
        return false;
    }
...
//{
    ...
    if (argc == 9) {
        ...
        if (!JS_ConvertArguments(cx, args, "uiiiiiuuo", &target, &level, &internalFormat, &width, &height, &border, &format, &type, &array)) {
            return false;
        }
        ...
        if (!JS_ConvertArguments(cx, args, "uiiuuo", &target, &level, &internalFormat, &format, &type, &image) || image == NULL) {
...
static bool native_NativeGL_constructor(JSContext *cx, unsigned argc, JS::Value *vp)
{
    ...
    JS_GetProperty(cx, JS_GetGlobalObject(cx /*, &args.callee()*/), "WebGLRenderingContext", &proto);
    webGLContext = JS_NewObject(cx, &WebGLRenderingContext_class, &proto.toObject(), JS::NullPtr());
