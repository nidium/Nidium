...
static JSPropertySpec WebGLActiveInfo_props[] = {
    {"size", JSPROP_PERMANENT | JSPROP_ENUMERATE | JSPROP_SHARED | JSPROP_NATIVE_ACCESSORS | JSPROP_READONLY,
        NATIVE_JS_STUBGETTER(),
        JSOP_NULLWRAPPER},
    {"type", JSPROP_PERMANENT | JSPROP_ENUMERATE | JSPROP_SHARED | JSPROP_NATIVE_ACCESSORS | JSPROP_READONLY,
        NATIVE_JS_STUBGETTER(),
        JSOP_NULLWRAPPER},
    {"name", JSPROP_PERMANENT | JSPROP_ENUMERATE | JSPROP_SHARED | JSPROP_NATIVE_ACCESSORS | JSPROP_READONLY,
        NATIVE_JS_STUBGETTER(),
        JSOP_NULLWRAPPER},
    JS_PS_END
};
...
//{
    ...
    JS::RootedObject protoObj(cx, JSVAL_TO_OBJECT(proto));
