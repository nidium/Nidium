...
static bool nidium_document_parseNML(JSContext *cx, unsigned argc, JS::Value *vp)
{
    ...
    JS::RootedObject retObj(cx, Nidium::Frontend::NML::BuildLST(cx, cstr.ptr()));
...
static bool nidium_document_getElementById(JSContext *cx, unsigned argc, JS::Value *vp)
{
    ...
    Graphics::CanvasHandler *elem = Nidium::Frontend::NativeContext::GetObject(cx)->getCanvasById(cid.ptr());
    if (elem) {
...
static bool nidium_document_getScreenData(JSContext *cx, unsigned argc, JS::Value *vp)
{
    ...
    Graphics::CanvasHandler *rootHandler = Nidium::Frontend::NativeContext::GetObject(cx)->getRootHandler();
...
static bool nidium_document_setPasteBuffer(JSContext *cx, unsigned argc, JS::Value *vp)
{
    ...
    Nidium::Frontend::NativeContext::GetObject(cx)->getUI()->setClipboardText(text);
...
static bool nidium_document_getPasteBuffer(JSContext *cx, unsigned argc, JS::Value *vp)
{
    ...
    size_t outputlen;
    char16_t * jsc;
    char *text = Nidium::Frontend::NativeContext::GetObject(cx)->getUI()->getClipboardText();
...
static bool nidium_document_showfps(JSContext *cx, unsigned argc, JS::Value *vp)
{
    ...
    if (show) {
        Nidium::Frontend::NativeContext::GetObject(cx)->createDebugCanvas();
    }
