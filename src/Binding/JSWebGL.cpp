...
#define NGL_JS_NEW_CLASS_OBJECT(NAME, VAR)                             \
    ...
    JS::RootedObject VAR(                                              \
        cx, JS_NewObject(cx, &NAME##_class, NAME##ProtoObj, JS::NullPtr()));
...
#define D_NGL_JS_FN(func_name) \
    static bool func_name(JSContext *cx, unsigned int argc, JS::Value *vp);

#define NGL_JS_FN(func_name)                                               \
    static bool func_name(JSContext *cx, unsigned int argc, JS::Value *vp) \
    {                                                                      \
        NIDIUM_JS_PROLOGUE_CLASS_NO_RET(Canvas3DContext,                   \
...
#define NIDIUM_GL_OBJECT_EXPOSE_NOT_INST(name)                         \
    ...
    {                                                                  \
        ...
        JS_DefineObject(cx, global, #name, &name##_class, nullptr, 0); \
    }

#define NGL_GET_RESOURCE(CLASS, OBJ, VAR)                              \
    VAR = static_cast<WebGLResource *>(                                \
        JS_GetInstancePrivate(cx, OBJ, &WebGL##CLASS##_class, &args)); \
    if (!VAR) return false;
...
public:
    ...
    void bind()
    {
        JS_SetReservedSlot(m_JSGLctx, m_Type, OBJECT_TO_JSVAL(m_JSObj));
    ...
    void bindTo(GLenum target)
    {
        ...
        if (!bindObject) {
            ...
            JS_SetReservedSlot(m_JSGLctx, m_Type, OBJECT_TO_JSVAL(bindObject));
        }
...
JSClass WebGLRenderingContext_class
    = { "WebGLRenderingContext",
        ...
        WebGLRenderingContext_Finalize, nullptr, nullptr, nullptr, nullptr,
        JSCLASS_NO_INTERNAL_MEMBERS };

static JSClass WebGLBuffer_class = { "WebGLBuffer",
                                     JSCLASS_HAS_PRIVATE,
                                     JS_PropertyStub,
...
static JSClass WebGLFramebuffer_class = { "WebGLFramebuffer",
                                          JSCLASS_HAS_PRIVATE,
                                          JS_PropertyStub,
                                          JS_DeletePropertyStub,
                                          JS_PropertyStub,
...
static JSClass WebGLProgram_class = { "WebGLProgram",
                                      JSCLASS_HAS_PRIVATE,
                                      JS_PropertyStub,
                                      JS_DeletePropertyStub,
                                      JS_PropertyStub,
...
static JSClass WebGLRenderbuffer_class = { "WebGLRenderbuffer",
                                           JSCLASS_HAS_PRIVATE,
                                           JS_PropertyStub,
                                           JS_DeletePropertyStub,
                                           JS_PropertyStub,
...
static JSClass WebGLShader_class = { "WebGLShader",
                                     JSCLASS_HAS_PRIVATE,
                                     JS_PropertyStub,
                                     JS_DeletePropertyStub,
                                     JS_PropertyStub,
...
static JSClass WebGLTexture_class = { "WebGLTexture",
                                      JSCLASS_HAS_PRIVATE,
                                      JS_PropertyStub,
                                      JS_DeletePropertyStub,
                                      JS_PropertyStub,
...
static JSClass WebGLUniformLocation_class = { "WebGLUniformLocation",
                                              JSCLASS_HAS_PRIVATE,
                                              JS_PropertyStub,
                                              JS_DeletePropertyStub,
                                              JS_PropertyStub,
...
static JSClass WebGLActiveInfo_class = { "WebGLActiveInfo",
                                         JSCLASS_HAS_PRIVATE,
                                         JS_PropertyStub,
                                         JS_DeletePropertyStub,
                                         JS_PropertyStub,
                   ...
                   int nb)
{
    ...
    clocation = (intptr_t)JS_GetInstancePrivate(
        cx, location, &WebGLUniformLocation_class, &args);
    ...
    switch (nb) {
        ...
        case 3:
            GL_CALL(glctx,
                    Uniform3f(clocation, (GLfloat)x, (GLfloat)y, (GLfloat)z));
            break;
        case 4:
            GL_CALL(glctx, Uniform4f(clocation, (GLfloat)x, (GLfloat)y,
                                     (GLfloat)z, (GLfloat)w));
            break;
    }
                          ...
                          int nb)
{
    ...
    switch (nb) {
        case 2:
            GL_CALL(glctx, UniformMatrix2fv(clocation, length / 4,
                                            (GLboolean)transpose, carray));
            break;
        case 3:
            GL_CALL(glctx, UniformMatrix3fv(clocation, length / 8,
                                            (GLboolean)transpose, carray));
            break;
        case 4:
            GL_CALL(glctx, UniformMatrix4fv(clocation, length / 16,
                                            (GLboolean)transpose, carray));
            break;
    }
...
static JSFunctionSpec WebGLRenderingContext_funcs[] = {
    JS_FS("isContextLost",
          WebGLRenderingContext_isContextLost,
          0,
          JSPROP_ENUMERATE),
    JS_FS("getExtension",
          WebGLRenderingContext_getExtension,
          1,
          JSPROP_ENUMERATE),
    JS_FS("activeTexture",
          WebGLRenderingContext_activeTexture,
          1,
          JSPROP_ENUMERATE),
    JS_FS("attachShader",
          WebGLRenderingContext_attachShader,
          2,
          JSPROP_ENUMERATE),
    JS_FS("bindAttribLocation",
          WebGLRenderingContext_bindAttribLocation,
          3,
          JSPROP_ENUMERATE),
    JS_FS("bindBuffer", WebGLRenderingContext_bindBuffer, 2, JSPROP_ENUMERATE),
    JS_FS("bindFramebuffer",
          WebGLRenderingContext_bindFramebuffer,
          2,
          JSPROP_ENUMERATE),
    JS_FS("bindRenderbuffer",
          WebGLRenderingContext_bindRenderbuffer,
          2,
          JSPROP_ENUMERATE),
    JS_FS(
        "bindTexture", WebGLRenderingContext_bindTexture, 2, JSPROP_ENUMERATE),
    JS_FS("copyTexImage2D",
          WebGLRenderingContext_copyTexImage2D,
          8,
          JSPROP_ENUMERATE),
    JS_FS("copyTexSubImage2D",
          WebGLRenderingContext_copyTexSubImage2D,
          8,
          JSPROP_ENUMERATE),
    JS_FS("blendEquation",
          WebGLRenderingContext_blendEquation,
          1,
          JSPROP_ENUMERATE),
    JS_FS("blendEquationSeparate",
          WebGLRenderingContext_blendEquationSeparate,
          2,
          JSPROP_ENUMERATE),
    JS_FS("blendFunc", WebGLRenderingContext_blendFunc, 2, JSPROP_ENUMERATE),
    JS_FS("blendFuncSeparate",
          WebGLRenderingContext_blendFuncSeparate,
          4,
          JSPROP_ENUMERATE),
    JS_FS("bufferData", WebGLRenderingContext_bufferData, 3, JSPROP_ENUMERATE),
    JS_FS("bufferSubData",
          WebGLRenderingContext_bufferSubData,
          3,
          JSPROP_ENUMERATE),
    ...
    JS_FS("clearStencil",
          WebGLRenderingContext_clearStencil,
          1,
          JSPROP_ENUMERATE),
    JS_FS("colorMask", WebGLRenderingContext_colorMask, 0, JSPROP_ENUMERATE),
    JS_FS("compileShader",
          WebGLRenderingContext_compileShader,
          1,
          JSPROP_ENUMERATE),
    JS_FS("texImage2D", WebGLRenderingContext_texImage2D, 6, JSPROP_ENUMERATE),
    JS_FS("createBuffer",
          WebGLRenderingContext_createBuffer,
          0,
          JSPROP_ENUMERATE),
    JS_FS("createFramebuffer",
          WebGLRenderingContext_createFramebuffer,
          0,
          JSPROP_ENUMERATE),
    JS_FS("createRenderbuffer",
          WebGLRenderingContext_createRenderbuffer,
          0,
          JSPROP_ENUMERATE),
    JS_FS("createProgram",
          WebGLRenderingContext_createProgram,
          0,
          JSPROP_ENUMERATE),
    JS_FS("createShader",
          ...
          JSPROP_ENUMERATE),
    JS_FS("createTexture",
          WebGLRenderingContext_createTexture,
          0,
          JSPROP_ENUMERATE),
    JS_FS("cullFace", WebGLRenderingContext_cullFace, 1, JSPROP_ENUMERATE),
    JS_FS("deleteBuffer",
          WebGLRenderingContext_deleteBuffer,
          1,
          JSPROP_ENUMERATE),
    JS_FS("deleteFramebuffer",
          WebGLRenderingContext_deleteFramebuffer,
          1,
          JSPROP_ENUMERATE),
    JS_FS("deleteProgram",
          WebGLRenderingContext_deleteProgram,
          1,
          JSPROP_ENUMERATE),
    JS_FS("deleteRenderbuffer",
          WebGLRenderingContext_deleteRenderbuffer,
          1,
          JSPROP_ENUMERATE),
    JS_FS("deleteShader",
          WebGLRenderingContext_deleteShader,
          1,
          JSPROP_ENUMERATE),
    JS_FS("deleteTexture",
          WebGLRenderingContext_deleteTexture,
          1,
          JSPROP_ENUMERATE),
    ...
    JS_FS("detachShader",
          WebGLRenderingContext_detachShader,
          2,
          JSPROP_ENUMERATE),
    JS_FS("disable", WebGLRenderingContext_disable, 1, JSPROP_ENUMERATE),
    JS_FS("disableVertexAttribArray",
          WebGLRenderingContext_disableVertexAttribArray,
          1,
          JSPROP_ENUMERATE),
    JS_FS("drawArrays", WebGLRenderingContext_drawArrays, 3, JSPROP_ENUMERATE),
    JS_FS("drawElements",
          WebGLRenderingContext_drawElements,
          4,
          JSPROP_ENUMERATE),
    JS_FS("enable", WebGLRenderingContext_enable, 1, JSPROP_ENUMERATE),
    JS_FS("enableVertexAttribArray",
          WebGLRenderingContext_enableVertexAttribArray,
          1,
          JSPROP_ENUMERATE),
    JS_FS("finish", WebGLRenderingContext_finish, 0, JSPROP_ENUMERATE),
    JS_FS("flush", WebGLRenderingContext_flush, 0, JSPROP_ENUMERATE),
    JS_FS("framebufferRenderbuffer",
          WebGLRenderingContext_framebufferRenderbuffer,
          4,
          JSPROP_ENUMERATE),
    JS_FS("framebufferTexture2D",
          WebGLRenderingContext_framebufferTexture2D,
          5,
          JSPROP_ENUMERATE),
    JS_FS("frontFace", WebGLRenderingContext_frontFace, 1, JSPROP_ENUMERATE),
    JS_FS("generateMipmap",
          WebGLRenderingContext_generateMipmap,
          1,
          JSPROP_ENUMERATE),
    JS_FS("getActiveAttrib",
          WebGLRenderingContext_getActiveAttrib,
          2,
          JSPROP_ENUMERATE),
    JS_FS("getActiveUniform",
          WebGLRenderingContext_getActiveUniform,
          2,
          JSPROP_ENUMERATE),
    JS_FS("getAttribLocation",
          WebGLRenderingContext_getAttribLocation,
          2,
          JSPROP_ENUMERATE),
    JS_FS("getParameter",
          WebGLRenderingContext_getParameter,
          1,
          JSPROP_ENUMERATE),
    JS_FS("getProgramParameter",
          WebGLRenderingContext_getProgramParameter,
          2,
          JSPROP_ENUMERATE),
    JS_FS("getProgramInfoLog",
          WebGLRenderingContext_getProgramInfoLog,
          1,
          JSPROP_ENUMERATE),
    JS_FS("getShaderParameter",
          WebGLRenderingContext_getShaderParameter,
          2,
          JSPROP_ENUMERATE),
    JS_FS("getShaderInfoLog",
          WebGLRenderingContext_getShaderInfoLog,
          1,
          JSPROP_ENUMERATE),
    JS_FS("getUniformLocation",
          WebGLRenderingContext_getUniformLocation,
          2,
          JSPROP_ENUMERATE),
    JS_FS("getShaderPrecisionFormat",
          WebGLRenderingContext_getShaderPrecisionFormat,
          2,
          JSPROP_ENUMERATE),
    JS_FS("lineWidth", WebGLRenderingContext_lineWidth, 1, JSPROP_ENUMERATE),
    JS_FS(
        "linkProgram", WebGLRenderingContext_linkProgram, 1, JSPROP_ENUMERATE),
    JS_FS(
        "pixelStorei", WebGLRenderingContext_pixelStorei, 2, JSPROP_ENUMERATE),
    JS_FS("renderbufferStorage",
          WebGLRenderingContext_renderbufferStorage,
          4,
          JSPROP_ENUMERATE),
    JS_FS("scissor", WebGLRenderingContext_scissor, 4, JSPROP_ENUMERATE),
    JS_FS("shaderSource",
          WebGLRenderingContext_shaderSource,
          2,
          JSPROP_ENUMERATE),
    JS_FS("texParameteri",
          WebGLRenderingContext_texParameteri,
          3,
          JSPROP_ENUMERATE),
    ...
    JS_FS("uniformMatrix2fv",
          WebGLRenderingContext_uniformMatrix2fv,
          3,
          JSPROP_ENUMERATE),
    JS_FS("uniformMatrix3fv",
          WebGLRenderingContext_uniformMatrix3fv,
          3,
          JSPROP_ENUMERATE),
    JS_FS("uniformMatrix4fv",
          WebGLRenderingContext_uniformMatrix4fv,
          3,
          JSPROP_ENUMERATE),
    JS_FS("vertexAttrib1f",
          WebGLRenderingContext_vertexAttrib1f,
          2,
          JSPROP_ENUMERATE),
    JS_FS("vertexAttrib1fv",
          WebGLRenderingContext_vertexAttrib1fv,
          2,
          JSPROP_ENUMERATE),
    JS_FS("vertexAttrib2f",
          WebGLRenderingContext_vertexAttrib2f,
          2,
          JSPROP_ENUMERATE),
    JS_FS("vertexAttrib2fv",
          WebGLRenderingContext_vertexAttrib2fv,
          2,
          JSPROP_ENUMERATE),
    JS_FS("vertexAttrib3f",
          WebGLRenderingContext_vertexAttrib3f,
          2,
          JSPROP_ENUMERATE),
    JS_FS("vertexAttrib3fv",
          WebGLRenderingContext_vertexAttrib3fv,
          2,
          JSPROP_ENUMERATE),
    JS_FS("vertexAttrib4f",
          WebGLRenderingContext_vertexAttrib4f,
          2,
          JSPROP_ENUMERATE),
    JS_FS("vertexAttrib4fv",
          WebGLRenderingContext_vertexAttrib4fv,
          2,
          JSPROP_ENUMERATE),
    JS_FS("vertexAttribPointer",
          WebGLRenderingContext_vertexAttribPointer,
          6,
          JSPROP_ENUMERATE),
...
JSConstDoubleSpec WebGLRenderingContext_const[] = {
    ...
    { NGL_POLYGON_OFFSET_FILL,
      "POLYGON_OFFSET_FILL",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_SAMPLE_ALPHA_TO_COVERAGE,
    ...
    { NGL_ALIASED_POINT_SIZE_RANGE,
      "ALIASED_POINT_SIZE_RANGE",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_ALIASED_LINE_WIDTH_RANGE,
    ...
    { NGL_POLYGON_OFFSET_UNITS,
      "POLYGON_OFFSET_UNITS",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_POLYGON_OFFSET_FACTOR,
      "POLYGON_OFFSET_FACTOR",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_TEXTURE_BINDING_2D,
      "TEXTURE_BINDING_2D",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_SAMPLE_BUFFERS, "SAMPLE_BUFFERS", JSPROP_ENUMERATE, { 0, 0, 0 } },
    { NGL_SAMPLES, "SAMPLES", JSPROP_ENUMERATE, { 0, 0, 0 } },
    { NGL_SAMPLE_COVERAGE_VALUE,
      "SAMPLE_COVERAGE_VALUE",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_SAMPLE_COVERAGE_INVERT,
      "SAMPLE_COVERAGE_INVERT",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    //{NGL_NUM_COMPRESSED_TEXTURE_FORMATS, "NUM_COMPRESSED_TEXTURE_FORMATS",
    // JSPROP_ENUMERATE, {0,
    // 0, 0}},
    { NGL_COMPRESSED_TEXTURE_FORMATS,
    ...
    { NGL_UNSIGNED_SHORT_4_4_4_4,
      "UNSIGNED_SHORT_4_4_4_4",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_UNSIGNED_SHORT_5_5_5_1,
      "UNSIGNED_SHORT_5_5_5_1",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_UNSIGNED_SHORT_5_6_5,
      "UNSIGNED_SHORT_5_6_5",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_FRAGMENT_SHADER, "FRAGMENT_SHADER", JSPROP_ENUMERATE, { 0, 0, 0 } },
    { NGL_VERTEX_SHADER, "VERTEX_SHADER", JSPROP_ENUMERATE, { 0, 0, 0 } },
    { NGL_MAX_VERTEX_ATTRIBS,
      "MAX_VERTEX_ATTRIBS",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_MAX_VERTEX_UNIFORM_VECTORS,
      "MAX_VERTEX_UNIFORM_VECTORS",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_MAX_VARYING_VECTORS,
      "MAX_VARYING_VECTORS",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_MAX_COMBINED_TEXTURE_IMAGE_UNITS,
      "MAX_COMBINED_TEXTURE_IMAGE_UNITS",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_MAX_VERTEX_TEXTURE_IMAGE_UNITS,
      "MAX_VERTEX_TEXTURE_IMAGE_UNITS",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_MAX_TEXTURE_IMAGE_UNITS,
      "MAX_TEXTURE_IMAGE_UNITS",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_MAX_FRAGMENT_UNIFORM_VECTORS,
    ...
    { NGL_NEAREST_MIPMAP_NEAREST,
      "NEAREST_MIPMAP_NEAREST",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_LINEAR_MIPMAP_NEAREST,
      "LINEAR_MIPMAP_NEAREST",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_NEAREST_MIPMAP_LINEAR,
      "NEAREST_MIPMAP_LINEAR",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_LINEAR_MIPMAP_LINEAR,
      "LINEAR_MIPMAP_LINEAR",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_TEXTURE_MAG_FILTER,
      "TEXTURE_MAG_FILTER",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_TEXTURE_MIN_FILTER,
      "TEXTURE_MIN_FILTER",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    ...
    { NGL_TEXTURE_BINDING_CUBE_MAP,
      "TEXTURE_BINDING_CUBE_MAP",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_TEXTURE_CUBE_MAP_POSITIVE_X,
      "TEXTURE_CUBE_MAP_POSITIVE_X",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_TEXTURE_CUBE_MAP_NEGATIVE_X,
      "TEXTURE_CUBE_MAP_NEGATIVE_X",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_TEXTURE_CUBE_MAP_POSITIVE_Y,
      "TEXTURE_CUBE_MAP_POSITIVE_Y",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_TEXTURE_CUBE_MAP_NEGATIVE_Y,
      "TEXTURE_CUBE_MAP_NEGATIVE_Y",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_TEXTURE_CUBE_MAP_POSITIVE_Z,
      "TEXTURE_CUBE_MAP_POSITIVE_Z",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_TEXTURE_CUBE_MAP_NEGATIVE_Z,
      "TEXTURE_CUBE_MAP_NEGATIVE_Z",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_MAX_CUBE_MAP_TEXTURE_SIZE,
    ...
    { NGL_VERTEX_ATTRIB_ARRAY_ENABLED,
      "VERTEX_ATTRIB_ARRAY_ENABLED",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_VERTEX_ATTRIB_ARRAY_SIZE,
      "VERTEX_ATTRIB_ARRAY_SIZE",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_VERTEX_ATTRIB_ARRAY_STRIDE,
      "VERTEX_ATTRIB_ARRAY_STRIDE",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_VERTEX_ATTRIB_ARRAY_TYPE,
      "VERTEX_ATTRIB_ARRAY_TYPE",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_VERTEX_ATTRIB_ARRAY_NORMALIZED,
      "VERTEX_ATTRIB_ARRAY_NORMALIZED",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_VERTEX_ATTRIB_ARRAY_POINTER,
      "VERTEX_ATTRIB_ARRAY_POINTER",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_VERTEX_ATTRIB_ARRAY_BUFFER_BINDING,
      "VERTEX_ATTRIB_ARRAY_BUFFER_BINDING",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    //{NGL_IMPLEMENTATION_COLOR_READ_TYPE, "IMPLEMENTATION_COLOR_READ_TYPE",
    // JSPROP_ENUMERATE, {0,
    // 0, 0}},
    //{NGL_IMPLEMENTATION_COLOR_READ_FORMAT, "IMPLEMENTATION_COLOR_READ_FORMAT",
    // JSPROP_ENUMERATE,
    //{0, 0, 0}},
    { NGL_COMPILE_STATUS, "COMPILE_STATUS", JSPROP_ENUMERATE, { 0, 0, 0 } },
    //{NGL_INFO_LOG_LENGTH, "INFO_LOG_LENGTH", JSPROP_ENUMERATE, {0, 0, 0}},
    //{NGL_SHADER_SOURCE_LENGTH, "SHADER_SOURCE_LENGTH", JSPROP_ENUMERATE, {0,
    // 0, 0}},
    ...
    { NGL_RENDERBUFFER_WIDTH,
      "RENDERBUFFER_WIDTH",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_RENDERBUFFER_HEIGHT,
      "RENDERBUFFER_HEIGHT",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_RENDERBUFFER_INTERNAL_FORMAT,
      "RENDERBUFFER_INTERNAL_FORMAT",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_RENDERBUFFER_RED_SIZE,
      "RENDERBUFFER_RED_SIZE",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_RENDERBUFFER_GREEN_SIZE,
      "RENDERBUFFER_GREEN_SIZE",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_RENDERBUFFER_BLUE_SIZE,
      "RENDERBUFFER_BLUE_SIZE",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_RENDERBUFFER_ALPHA_SIZE,
      "RENDERBUFFER_ALPHA_SIZE",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_RENDERBUFFER_DEPTH_SIZE,
      "RENDERBUFFER_DEPTH_SIZE",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_RENDERBUFFER_STENCIL_SIZE,
      "RENDERBUFFER_STENCIL_SIZE",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE,
      "FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_FRAMEBUFFER_ATTACHMENT_OBJECT_NAME,
      "FRAMEBUFFER_ATTACHMENT_OBJECT_NAME",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL,
      "FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE,
      "FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_COLOR_ATTACHMENT0,
      "COLOR_ATTACHMENT0",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_DEPTH_ATTACHMENT, "DEPTH_ATTACHMENT", JSPROP_ENUMERATE, { 0, 0, 0 } },
    { NGL_STENCIL_ATTACHMENT,
      "STENCIL_ATTACHMENT",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_DEPTH_STENCIL_ATTACHMENT,
      "DEPTH_STENCIL_ATTACHMENT",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_NONE, "NONE", JSPROP_ENUMERATE, { 0, 0, 0 } },
    { NGL_FRAMEBUFFER_COMPLETE,
      "FRAMEBUFFER_COMPLETE",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT,
      "FRAMEBUFFER_INCOMPLETE_ATTACHMENT",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT,
      "FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    //{NGL_FRAMEBUFFER_INCOMPLETE_DIMENSIONS_EXT,
    //"FRAMEBUFFER_INCOMPLETE_DIMENSIONS",
    // JSPROP_ENUMERATE, {0, 0, 0}},
    { NGL_FRAMEBUFFER_UNSUPPORTED,
      "FRAMEBUFFER_UNSUPPORTED",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_FRAMEBUFFER_BINDING,
      "FRAMEBUFFER_BINDING",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_RENDERBUFFER_BINDING,
      "RENDERBUFFER_BINDING",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_MAX_RENDERBUFFER_SIZE,
      "MAX_RENDERBUFFER_SIZE",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_INVALID_FRAMEBUFFER_OPERATION,
      "INVALID_FRAMEBUFFER_OPERATION",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_UNPACK_FLIP_Y_WEBGL,
      "UNPACK_FLIP_Y_WEBGL",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_UNPACK_PREMULTIPLY_ALPHA_WEBGL,
      "UNPACK_PREMULTIPLY_ALPHA_WEBGL",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_CONTEXT_LOST_WEBGL,
      "CONTEXT_LOST_WEBGL",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_UNPACK_COLORSPACE_CONVERSION_WEBGL,
      "UNPACK_COLORSPACE_CONVERSION_WEBGL",
      JSPROP_ENUMERATE,
      { 0, 0, 0 } },
    { NGL_BROWSER_DEFAULT_WEBGL,
...
static JSFunctionSpec WebGLActiveInfo_funcs[] = { JS_FS_END };

static JSPropertySpec WebGLActiveInfo_props[] = { JS_PS_END };
...
if (!JS_ConvertArguments(
        cx, args, "ouS", program.address(), &vertex, name.address())) {
    return false;
}
...
if (buffer == NULL) {
    ...
    WebGLResource::UnbindFrom(cx, thisobj, WebGLResource::kRenderbuffer,
                              target);
    return true;
}
...
if (!JS_ConvertArguments(
        cx, args, "uuuu", &srcRGB, &dstRGB, &srcAlpha, &dstAlpha)) {
    return false;
}
...
JS::RootedObject
    ret(cx, JS_NewObject(cx, &WebGLBuffer_class, protoObj, JS::NullPtr()));

JS_SetPrivate(ret,
              new WebGLResource(
                  buffer, WebGLResource::kBuffer, cx, CppObj, thisobj, ret));
...
JS::RootedObject protoObj(cx, proto.toObjectOrNull());
JS::RootedObject
    ret(cx, JS_NewObject(cx, &WebGLFramebuffer_class, protoObj, JS::NullPtr()));

JS_SetPrivate(ret,
              new WebGLResource(buffer,
                                WebGLResource::kFramebuffer,
                                cx,
                                CppObj,
                                thisobj,
                                ret));
...
JS::RootedObject
    ret(cx,
        JS_NewObject(cx, &WebGLRenderbuffer_class, protoObj, JS::NullPtr()));

JS_SetPrivate(ret,
              new WebGLResource(buffer,
                                WebGLResource::kRenderbuffer,
                                cx,
                                CppObj,
                                thisobj,
                                ret));
...
JS::RootedObject protoObj(cx, proto.toObjectOrNull());
JS::RootedObject
    ret(cx, JS_NewObject(cx, &WebGLProgram_class, protoObj, JS::NullPtr()));

JS_SetPrivate(ret,
              new WebGLResource(
                  program, WebGLResource::kProgram, cx, CppObj, thisobj, ret));
...
JS::RootedObject protoObj(cx, proto.toObjectOrNull());
JS::RootedObject
    ret(cx, JS_NewObject(cx, &WebGLShader_class, protoObj, JS::NullPtr()));

WebGLResource *res = new WebGLResource(
    cshader, WebGLResource::kShader, cx, CppObj, thisobj, ret);
...
JS::RootedObject protoObj(cx, proto.toObjectOrNull());
JS::RootedObject
    ret(cx, JS_NewObject(cx, &WebGLTexture_class, protoObj, JS::NullPtr()));

JS_SetPrivate(ret,
              new WebGLResource(
                  texture, WebGLResource::kTexture, cx, CppObj, thisobj, ret));
...
if (location < 0) {
    ...
    JS::RootedObject protoObj(cx, proto.toObjectOrNull());
    JS::RootedObject ret(cx, JS_NewObject(cx, &WebGLUniformLocation_class,
                                          protoObj, JS::NullPtr()));
...
JS::RootedObject obj(cx,
                     JS_NewObject(cx,
                                  &WebGLShaderPrecisionFormat_class,
                                  protoObj,
                                  JS::NullPtr()));
...
GL_CALL(CppObj,
        FramebufferRenderbuffer(
            target, attachement, renderbuffertarget, crenderbuffer->id()));
...
GL_CALL(CppObj,
        FramebufferTexture2D(
            target, attachement, textarget, ctexture->id(), level));
...
int len;
// GL_CALL(CppObj, GetActiveAttrib(cprogram->id(), index, 2048, &len, &size,
// &type, name))
...
switch (name) {
    ...
    case NGL_STENCIL_WRITEMASK: {
        ...
        double i_double(i_unsigned); // pass as FP value to allow large values
                                     // such as 2^32-1.
...
// float
    ...
    case NGL_UNPACK_PREMULTIPLY_ALPHA_WEBGL:
        value.setBoolean(CppObj->hasFlag(
...
if (!JS_ConvertArguments(
        cx, args, "uuii", &target, &internalFormat, &width, &height)) {
    return false;
}
...
if (argc == 9) {
    ...
    GL_CALL(CppObj, TexImage2D(target, level, internalFormat, width, height,
    ...
    if (!JS_ConvertArguments(cx, args, "uiiuuo", &target, &level,
                             &internalFormat, &format, &type, image.address())
        || image == NULL) {
    ...
    GL_CALL(CppObj, TexImage2D(target, level, internalFormat, width, height, 0,
                               format, type, pixels));
...
static bool
JSWebGLRenderingContext_constructor(JSContext *cx, unsigned argc, JS::Value *vp)
{
...
void JSWebGLRenderingContext::RegisterObject(JSContext *cx)
{
    ...
    JS::RootedObject obj(
        cx,
        JS_InitClass(cx, global, JS::NullPtr(), &WebGLRenderingContext_class,
                     JSWebGLRenderingContext_constructor, 0, nullptr,
                     WebGLRenderingContext_funcs, nullptr, nullptr));
