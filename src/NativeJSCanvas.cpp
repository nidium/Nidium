...
static JSFunctionSpec canvas_funcs[] = {
    JS_FN("getContext", native_canvas_getContext, 1, NATIVE_JS_FNPROPS),
    JS_FN("setContext", native_canvas_setContext, 1, NATIVE_JS_FNPROPS),
    JS_FN("add", native_canvas_addSubCanvas, 1, NATIVE_JS_FNPROPS),
    JS_FN("insertBefore", native_canvas_insertBefore, 2, NATIVE_JS_FNPROPS),
    JS_FN("insertAfter", native_canvas_insertAfter, 2, NATIVE_JS_FNPROPS),
    JS_FN("removeFromParent", native_canvas_removeFromParent, 0, NATIVE_JS_FNPROPS),
    JS_FN("show", native_canvas_show, 0, NATIVE_JS_FNPROPS),
    JS_FN("hide", native_canvas_hide, 0, NATIVE_JS_FNPROPS),
    JS_FN("bringToFront", native_canvas_bringToFront, 0, NATIVE_JS_FNPROPS),
    JS_FN("sendToBack", native_canvas_sendToBack, 0, NATIVE_JS_FNPROPS),
    JS_FN("getParent", native_canvas_getParent, 0, NATIVE_JS_FNPROPS),
    JS_FN("getFirstChild", native_canvas_getFirstChild, 0, NATIVE_JS_FNPROPS),
    JS_FN("getLastChild", native_canvas_getLastChild, 0, NATIVE_JS_FNPROPS),
    JS_FN("getNextSibling", native_canvas_getNextSibling, 0, NATIVE_JS_FNPROPS),
    JS_FN("getPrevSibling", native_canvas_getPrevSibling, 0, NATIVE_JS_FNPROPS),
    JS_FN("getChildren", native_canvas_getChildren, 0, NATIVE_JS_FNPROPS),
    JS_FN("setCoordinates", native_canvas_setCoordinates, 2, NATIVE_JS_FNPROPS),
    JS_FN("translate", native_canvas_translate, 2, NATIVE_JS_FNPROPS),
    JS_FN("getVisibleRect", native_canvas_getVisibleRect, 0, NATIVE_JS_FNPROPS),
    JS_FN("setSize", native_canvas_setSize, 2, NATIVE_JS_FNPROPS),
    JS_FN("clear", native_canvas_clear, 0, NATIVE_JS_FNPROPS),
    JS_FN("setZoom", native_canvas_setZoom, 1, NATIVE_JS_FNPROPS),
    JS_FN("setScale", native_canvas_setScale, 2, NATIVE_JS_FNPROPS),
    JS_FS_END
};
