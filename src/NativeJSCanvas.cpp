...
static JSFunctionSpec canvas_funcs[] = {
    JS_FN("getContext", native_canvas_getContext, 1, JSFUNCTIONPROPS),
    JS_FN("setContext", native_canvas_setContext, 1, JSFUNCTIONPROPS),
    JS_FN("add", native_canvas_addSubCanvas, 1, JSFUNCTIONPROPS),
    JS_FN("insertBefore", native_canvas_insertBefore, 2, JSFUNCTIONPROPS),
    JS_FN("insertAfter", native_canvas_insertAfter, 2, JSFUNCTIONPROPS),
    JS_FN("removeFromParent", native_canvas_removeFromParent, 0, JSFUNCTIONPROPS),
    JS_FN("show", native_canvas_show, 0, JSFUNCTIONPROPS),
    JS_FN("hide", native_canvas_hide, 0, JSFUNCTIONPROPS),
    JS_FN("bringToFront", native_canvas_bringToFront, 0, JSFUNCTIONPROPS),
    JS_FN("sendToBack", native_canvas_sendToBack, 0, JSFUNCTIONPROPS),
    JS_FN("getParent", native_canvas_getParent, 0, JSFUNCTIONPROPS),
    JS_FN("getFirstChild", native_canvas_getFirstChild, 0, JSFUNCTIONPROPS),
    JS_FN("getLastChild", native_canvas_getLastChild, 0, JSFUNCTIONPROPS),
    JS_FN("getNextSibling", native_canvas_getNextSibling, 0, JSFUNCTIONPROPS),
    JS_FN("getPrevSibling", native_canvas_getPrevSibling, 0, JSFUNCTIONPROPS),
    JS_FN("getChildren", native_canvas_getChildren, 0, JSFUNCTIONPROPS),
    JS_FN("setCoordinates", native_canvas_setCoordinates, 2, JSFUNCTIONPROPS),
    JS_FN("translate", native_canvas_translate, 2, JSFUNCTIONPROPS),
    JS_FN("getVisibleRect", native_canvas_getVisibleRect, 0, JSFUNCTIONPROPS),
    JS_FN("setSize", native_canvas_setSize, 2, JSFUNCTIONPROPS),
    JS_FN("clear", native_canvas_clear, 0, JSFUNCTIONPROPS),
    JS_FN("setZoom", native_canvas_setZoom, 1, JSFUNCTIONPROPS),
    JS_FN("setScale", native_canvas_setScale, 2, JSFUNCTIONPROPS),
    JS_FS_END
};
