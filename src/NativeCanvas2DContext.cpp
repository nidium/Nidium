...
static JSFunctionSpec canvas2dctx_funcs[] = {
    JS_FN("breakText", native_canvas2dctx_breakText, 2, JSFUNCTIONPROPS),
    JS_FN("shadow", native_canvas2dctx_shadow, 0, JSFUNCTIONPROPS),
    JS_FN("onerror", native_canvas2dctx_stub, 0, JSFUNCTIONPROPS),
    JS_FN("fillRect", native_canvas2dctx_fillRect, 4, JSFUNCTIONPROPS),
    JS_FN("fillText", native_canvas2dctx_fillText, 3, JSFUNCTIONPROPS),
    JS_FN("strokeText", native_canvas2dctx_strokeText, 3, JSFUNCTIONPROPS),
    JS_FN("strokeRect", native_canvas2dctx_strokeRect, 4, JSFUNCTIONPROPS),
    JS_FN("clearRect", native_canvas2dctx_clearRect, 4, JSFUNCTIONPROPS),
    JS_FN("beginPath", native_canvas2dctx_beginPath, 0, JSFUNCTIONPROPS),
    JS_FN("moveTo", native_canvas2dctx_moveTo, 2, JSFUNCTIONPROPS),
    JS_FN("lineTo", native_canvas2dctx_lineTo, 2, JSFUNCTIONPROPS),
    JS_FN("fill", native_canvas2dctx_fill, 0, JSFUNCTIONPROPS),
    JS_FN("stroke", native_canvas2dctx_stroke, 0, JSFUNCTIONPROPS),
    JS_FN("closePath", native_canvas2dctx_closePath, 0, JSFUNCTIONPROPS),
    JS_FN("clip", native_canvas2dctx_clip, 0, JSFUNCTIONPROPS),
    JS_FN("arc", native_canvas2dctx_arc, 5, JSFUNCTIONPROPS),
    JS_FN("arcTo", native_canvas2dctx_arcTo, 5, JSFUNCTIONPROPS),
    JS_FN("rect", native_canvas2dctx_rect, 4, JSFUNCTIONPROPS),
    JS_FN("quadraticCurveTo", native_canvas2dctx_quadraticCurveTo, 4, JSFUNCTIONPROPS),
    JS_FN("bezierCurveTo", native_canvas2dctx_bezierCurveTo, 4, JSFUNCTIONPROPS),
    JS_FN("rotate", native_canvas2dctx_rotate, 1, JSFUNCTIONPROPS),
    JS_FN("scale", native_canvas2dctx_scale, 2, JSFUNCTIONPROPS),
    JS_FN("save", native_canvas2dctx_save, 0, JSFUNCTIONPROPS),
    JS_FN("restore", native_canvas2dctx_restore, 0, JSFUNCTIONPROPS),
    JS_FN("translate", native_canvas2dctx_translate, 2, JSFUNCTIONPROPS),
    JS_FN("transform", native_canvas2dctx_transform, 6, JSFUNCTIONPROPS),
    JS_FN("iTransform", native_canvas2dctx_iTransform, 0, JSFUNCTIONPROPS),
    JS_FN("setTransform", native_canvas2dctx_setTransform, 6, JSFUNCTIONPROPS),
    JS_FN("createLinearGradient", native_canvas2dctx_createLinearGradient, 4, JSFUNCTIONPROPS),
    JS_FN("createRadialGradient", native_canvas2dctx_createRadialGradient, 6, JSFUNCTIONPROPS),
    JS_FN("createImageData", native_canvas2dctx_createImageData, 2, JSFUNCTIONPROPS),
    JS_FN("createPattern", native_canvas2dctx_createPattern, 2, JSFUNCTIONPROPS),
    JS_FN("putImageData", native_canvas2dctx_putImageData, 3, JSFUNCTIONPROPS),
    JS_FN("getImageData", native_canvas2dctx_getImageData, 4, JSFUNCTIONPROPS),
    JS_FN("drawImage", native_canvas2dctx_drawImage, 3, JSFUNCTIONPROPS),
    JS_FN("measureText", native_canvas2dctx_measureText, 1, JSFUNCTIONPROPS),
    JS_FN("isPointInPath", native_canvas2dctx_isPointInPath, 2, JSFUNCTIONPROPS),
    JS_FN("getPathBounds", native_canvas2dctx_getPathBounds, 0, JSFUNCTIONPROPS),
    JS_FN("light", native_canvas2dctx_light, 3, JSFUNCTIONPROPS),
    JS_FN("attachFragmentShader", native_canvas2dctx_attachGLSLFragment, 1, JSFUNCTIONPROPS),
    JS_FN("detachFragmentShader", native_canvas2dctx_detachGLSLFragment, 0, JSFUNCTIONPROPS),
    JS_FN("setVertexOffset", native_canvas2dctx_setVertexOffset, 3, JSFUNCTIONPROPS),
    JS_FS_END
};

static JSFunctionSpec gradient_funcs[] = {

    JS_FN("addColorStop", native_canvas2dctxGradient_addColorStop, 2, JSFUNCTIONPROPS),
...
static JSFunctionSpec glprogram_funcs[] = {
    ...
    JS_FN("getUniformLocation", native_canvas2dctxGLProgram_getUniformLocation, 1, JSFUNCTIONPROPS),
    JS_FN("getActiveUniforms", native_canvas2dctxGLProgram_getActiveUniforms, 0, JSFUNCTIONPROPS),
    JS_FN("uniform1i", native_canvas2dctxGLProgram_uniform1i, 2, JSFUNCTIONPROPS),
    JS_FN("uniform1f", native_canvas2dctxGLProgram_uniform1f, 2, JSFUNCTIONPROPS),
    JS_FN("uniform1iv", native_canvas2dctxGLProgram_uniform1iv, 2, JSFUNCTIONPROPS),
    JS_FN("uniform2iv", native_canvas2dctxGLProgram_uniform2iv, 2, JSFUNCTIONPROPS),
    JS_FN("uniform3iv", native_canvas2dctxGLProgram_uniform3iv, 2, JSFUNCTIONPROPS),
    JS_FN("uniform4iv", native_canvas2dctxGLProgram_uniform4iv, 2, JSFUNCTIONPROPS),

    JS_FN("uniform1fv", native_canvas2dctxGLProgram_uniform1fv, 2, JSFUNCTIONPROPS),
    JS_FN("uniform2fv", native_canvas2dctxGLProgram_uniform2fv, 2, JSFUNCTIONPROPS),
    JS_FN("uniform3fv", native_canvas2dctxGLProgram_uniform3fv, 2, JSFUNCTIONPROPS),
    JS_FN("uniform4fv", native_canvas2dctxGLProgram_uniform4fv, 2, JSFUNCTIONPROPS),
    JS_FS_END
};
