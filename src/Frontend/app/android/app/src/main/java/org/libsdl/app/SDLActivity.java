...
public class SDLActivity extends Activity {
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        Log.v("Debug", "dispatchKeyEvent" + keyCode);
    ...
    public static boolean showTextInput(int x, int y, int w, int h) {
        if (mSingleton.mIgnoreShowTextInput) {
            // On first load, SDL show the text input, but we don't want that for nidium
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback, 
    ...
    public boolean onKey(View  v, int keyCode, KeyEvent event) {
        ...
        if( (event.getSource() & InputDevice.SOURCE_KEYBOARD) != 0) {
            Log.v("Debug", "View got KeyEvent " + keyCode);
            if (event.getAction() == KeyEvent.ACTION_DOWN) {
...
class SDLInputConnection extends BaseInputConnection {
    ...
    public boolean sendKeyEvent(KeyEvent event) {
        ...
        Log.v("Debug", "Send key event from here");
        /*
