...
g++ \
    ...
    -Wl,--start-group \
    -lnativestudio -lnativenetwork -lcares -ljs_static -lzlib -ljpeg\
    -lskia_sfnt -lskia_opts_ssse3 -lskia_opts -lskia_utils -lpicture_utils -lskia_ports -lskia_images -lskia_skgr -lskia_gr -lskia_effects -lskia_core \
    -Wl,--end-group
