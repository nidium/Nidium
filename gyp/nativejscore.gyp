...

{
    'targets': [{
        ...
        'sources': [
            ...
            '../src/JS/NativeJS.cpp',
            '../src/JS/NativeJSExposer.cpp',
            '../src/JS/NativeJSFileIO.cpp',
            '../src/JS/NativeJSHttp.cpp',
            '../src/JS/NativeJSModules.cpp',
            '../src/JS/NativeJSDebugger.cpp',
            '../src/JS/NativeJSSocket.cpp',
            '../src/JS/NativeJSThread.cpp',
            '../src/JS/NativeJSHTTPListener.cpp',
            '../src/JS/NativeJSDebug.cpp',
            '../src/JS/NativeJSConsole.cpp',
            '../src/JS/NativeJSFS.cpp',
            '../src/JS/NativeJSProcess.cpp',
